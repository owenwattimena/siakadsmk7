...
@section('content')
            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ route('dashboard-siswa.saran') }}" method="POST">
                            @csrf
                        ...
                        @foreach ($saran as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('dashboard-siswa.saran-delete', $item->id) }}" method="POST" style="display: inline">
                                        @csrf
                                        @method('delete')
    ...
    <div class="modal fade" id="modal-default-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('dashboard-siswa.saran-update') }}" method="POST">
                    @csrf
                    @method('put')
