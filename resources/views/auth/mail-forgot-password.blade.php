                ...
                <tr>
                    <td class="esd-email-paddings" valign="top">
                            ...
                            <tbody>
                                <tr>
                                    <td class="es-adaptive esd-stripe" align="center" esd-custom-block-id="88593">
                                        <table class="es-header-body" style="background-color: #3d5ca3;" width="600"
                                            cellspacing="0" cellpadding="0" bgcolor="#3d5ca3" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p20t es-p20b es-p20r es-p20l"
                                                        style="background-color: #3d5ca3;" bgcolor="#3d5ca3"
                                                        align="left">
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="270"
                                                                        ...
                                                                        <table width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p10t es-m-txt-c"
                                                                                        align="right"><span
                                                                                            class="es-button-border"><a
                                                                                                href="https://viewstripo.email/"
                                                                                                class="es-button"
                                                                                                target="_blank">Try free
                                                                                                class</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" style="background-color: #fafafa;" bgcolor="#fafafa"
                                        align="center">
                                        <table class="es-content-body" style="background-color: #ffffff;" width="600"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p40t es-p20r es-p20l"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560"
                                                                        ...
                                                                        <table style="background-position: left top;"
                                                                            width="100%" cellspacing="0"
                                                                            cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p5t es-p5b"
                                                                                        align="center"
                                                                                        style="font-size:0"><a
                                                                                            target="_blank"><img
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p15b"
                                                                                        align="center">
                                                                                        <h1
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p40r es-p40l"
                                                                                        align="left">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p35r es-p40l"
                                                                                        align="left">
                                                                                        <p style="text-align: center;">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p25t es-p40r es-p40l"
                                                                                        align="center">
                                                                                        <p>If did not make this request,
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l"
                                                                                        align="center"><span
                                                                                            class="es-button-border"><a
                                                                                                href="{{ url($token . '/reset-password') }}"
                                                                                                class="es-button"
                                                                                                target="_blank">RESET
                                                                                                PASSWORD</a></span></td>
                                                                                </tr>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p20t es-p10r es-p10l"
                                                        ...
                                                        <table class="es-left" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="199"
                                                                        align="left">
                                                                        <table
                                                        ...
                                                        <table class="es-right" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="361"
                                                                        align="left">
                                                                        <table
                                                                            style="background-position: center center;"
                                                                            width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-social es-p10t es-p5b es-m-txt-c"
                                                                                        align="left"
                                                                                        style="font-size:0">
                                                                                        <table
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p5t es-p20b es-p20r es-p20l"
                                                        style="background-position: left top;" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560"
                                                                                    ...
                                                                                    <td class="esd-block-text"
                                                                                        ...
                                                                                        <p style="font-size: 14px;">
                                                                                            ...
                                                                                            | <a target="_blank"
                                                                                                ...
                                                                                                style="font-size: 14px; color: #666666;">your@mail.com</a>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                ...
                                <tr>
                                    <td class="esd-stripe" style="background-color: #fafafa;" bgcolor="#fafafa"
                                        ...
                                        <table class="es-footer-body" width="600" cellspacing="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p10t es-p30b es-p20r es-p20l"
                                                        style=" background-color: #0b5394; background-position: left top;"
                                                                    ...
                                                                    <td class="esd-container-frame" width="560"
                                                                        ...
                                                                        <table width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td esd-links-underline="none"
                                                                                        esd-links-color="#ffffff"
                                                                                        class="esd-block-text es-p5b"
                                                                                        align="left">
                                                                                        <p
                                                                                            style="font-size: 14px; color: #ffffff;">
                                                                                            We are here to help, learn
                                                                                            more about us <a
                                                                                                target="_blank"
                                                                                                style="font-size: 14px; color: #ffffff; text-decoration: none;">here</a>
                                                                                        </p>
                                                                                        <p
                                                                                            style="font-size: 14px; color: #ffffff;">
                                                                                            or <a target="_blank"
                                                                                                style="font-size: 14px; text-decoration: none; color: #ffffff;">contact
                                                                                                us</a><br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                ...
                                <tr>
                                    <td class="esd-stripe" style="background-color: #fafafa;" bgcolor="#fafafa"
                                        ...
                                        <table class="es-content-body" style="background-color: transparent;"
                                            width="600" cellspacing="0" cellpadding="0" bgcolor="transparent"
                                            align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p15t"
                                                        style="background-position: left top;" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="600"
                                                                        ...
                                                                        <table width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr class="links">
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l"
                                                                                                        ...
                                                                                                        <a target="_blank"
                                                                                                            href="https://viewstripo.email"
                                                                                                            style="color: #3D5CA3; font-size: 14px;">Sing
                                                                                                            up</a>
                                                                                                    </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l"
                                                                                                        style="border-left: 1px solid #3d5ca3; padding-bottom: 1px; padding-top: 0px; "
                                                                                                        width="33.33%"
                                                                                                        valign="top"
                                                                                                        bgcolor="transparent"
                                                                                                        align="center">
                                                                                                        <a target="_blank"
                                                                                                            href="https://viewstripo.email"
                                                                                                            style="color: #3D5CA3; font-size: 14px;">Blog</a>
                                                                                                    </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l"
                                                                                                        style="border-left: 1px solid #3d5ca3; padding-bottom: 1px; padding-top: 0px; "
                                                                                                        width="33.33%"
                                                                                                        ...
                                                                                                        <a target="_blank"
                                                                                                            href="https://viewstripo.email"
                                                                                                            style="color: #3D5CA3; font-size: 14px;">About
                                                                                                            us</a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-spacer es-p20b es-p20r es-p20l"
                                                                                        align="center"
                                                                                        style="font-size:0">
                                                                                        <table width="100%"
                                                                                            height="100%"
                        ...
                        <table class="es-footer" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" style="background-color: #fafafa;" bgcolor="#fafafa"
                                        align="center" esd-custom-block-id="88330">
                                        <table class="es-footer-body" style="background-color: transparent;" width="600"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p15t es-p5b es-p20r es-p20l"
                                                        align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560"
                                                                        ...
                                                                        <table width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td esd-links-underline="underline"
                                                                                        align="center"
                                                                                        class="esd-block-text">
                                                                                        <p
                                                                                            style="font-size: 12px; color: #666666;">
                                                                                            This daily newsletter was
                                                                                            sent to info@name.com from
                                                                                            company name because you
                                                                                            subscribed. If you would not
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-infoblock made_with"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            target="_blank"
                                                                                            href="https://viewstripo.email/?utm_source=templates&utm_medium=email&utm_campaign=education&utm_content=trigger_newsletter2"><img
